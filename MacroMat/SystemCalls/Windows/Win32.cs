...
internal class Win32
{
    ...
    public enum WindowsScanCode : short
    {
        LBUTTON = 0,
        RBUTTON = 0,
        CANCEL = 70,
    ...
    public enum WindowsVirtualKey
    {
        ...
        /// <summary>
        ///     Windows 2000/XP: Used to pass Unicode characters as if they were keystrokes. The VK_PACKET key is the low word of a
    ...
    [DllImport(User32, SetLastError = true)]
    public static extern uint SendInput(uint cInputs, INPUT[] inputs, int cbSize);
    ...
    {
        public WindowsVirtualKey wVk;
        public WindowsScanCode wScan;
        public KEYBDEVENTF dwFlags;
        public int time;
        public UIntPtr dwExtraInfo;
    }
